...
final class SettingsViewController: UIViewController {
    ...
    private func setupConstraintsAutomatic(_ bool: Bool) {
        stickyHeaderView.translatesAutoresizingMaskIntoConstraints = bool
...
private enum Design {
    ...
    static let scrollViewContentInsets = UIEdgeInsets(top: headerMaxHeight - headerMinHeight, left: 0, bottom: -(headerMaxHeight - headerMinHeight), right: 0)
